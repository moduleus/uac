...
if(NOT CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
  ...
  if("${CCACHE_PROGRAM}" STREQUAL "CCACHE_PROGRAM-NOTFOUND")
    ...
    option(CCACHE "Use ccache for compiler caching to speed up rebuilds." OFF)
  endif()
endif()
...
if(SCCACHE)
  ...
  if(NOT DEFINED ENV{RUSTC_WRAPPER})
    ...
    set(CMAKE_RUSTC_WRAPPER
        "${SCCACHE_PROGRAM}"
        CACHE PATH "RUSTC_WRAPPER detected by CMake")
  endif()
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
    ...
    if(IS_MULTI_CONFIG)
      foreach(CONFIG ${CMAKE_CONFIGURATION_TYPES})
        ...
        string(REPLACE "/Zi" "/Z7" CMAKE_CXX_FLAGS_${CONFIG}
                       "${CMAKE_CXX_FLAGS_${CONFIG}}")
        string(REPLACE "/Zi" "/Z7" CMAKE_C_FLAGS_${CONFIG}
...
elseif(CCACHE)
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
    message(
      STATUS
        "No compiler caching enabled. Install sccache to speed up rebuilds.")
  else()
    message(
      STATUS
        "No compiler caching enabled. Install ccache or sccache to speed up rebuilds."
    )
  endif()
endif()
