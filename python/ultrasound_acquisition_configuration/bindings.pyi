...
class TransmitSetup:
    ...
    excitations: VecWeakExcitationPtr | list[Excitation]
    hw_config: HwConfig
    probe: urx.Probe
    probe_transform: urx.Transform
    time_offset: urx.DoubleNan | float | int
...
class VecWeakExcitationPtr:
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, arg0: VecWeakExcitationPtr | list[Excitation]) -> None: ...
    @overload
    def __init__(self, arg0: Iterable) -> None: ...
    def append(self, x: Excitation) -> None: ...
    def clear(self) -> None: ...
    def count(self, x: Excitation) -> int: ...
    @overload
    def extend(self, L: VecWeakExcitationPtr | list[Excitation]) -> None: ...
    @overload
    def extend(self, L: Iterable) -> None: ...
    def insert(self, i: int, x: Excitation) -> None: ...
    @overload
    ...
    def __delitem__(self, arg0: slice) -> None: ...
    @overload
    def __eq__(self, arg0: VecWeakExcitationPtr | list[Excitation]) -> bool: ...
    @overload
    def __eq__(self, arg0: VecExcitationPtr | list[Excitation]) -> bool: ...
    @overload
    def __getitem__(self, s: slice) -> VecWeakExcitationPtr: ...
    @overload
    def __getitem__(self, arg0: int) -> Excitation: ...
    def __iter__(self) -> Iterator[Excitation]: ...
    def __len__(self) -> int: ...
    def __ne__(self, arg0: VecWeakExcitationPtr | list[Excitation]) -> bool: ...
    @overload
    def __setitem__(self, arg0: int, arg1: Excitation) -> None: ...
    @overload
    def __setitem__(self, arg0: slice, arg1: VecWeakExcitationPtr | list[Excitation]) -> None: ...
